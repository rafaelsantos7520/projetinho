                            ...
                            <tr class="hover:bg-slate-50 transition-colors group">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-3">
                                        ...
                                        <a href="{{ route('tenant_admin.products.edit', ['product' => $product, 'tenant' => $tenantSlug]) }}"
                                            class="text-slate-400 hover:text-indigo-600 font-medium transition-colors">
                                            Editar
                                        </a>
                                        <form method="POST" action="{{ route('tenant_admin.products.duplicate', ['product' => $product, 'tenant' => $tenantSlug]) }}"
