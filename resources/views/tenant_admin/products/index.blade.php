<x-layouts.app :title="'Admin da Loja'" :subtitle="'Dashboard'">
    ...
    <div class="max-w-6xl mx-auto space-y-8">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-slate-900">Produtos da sua loja {{ $tenantSlug }}</h1>
                            ...
                            <tr class="hover:bg-slate-50 transition-colors group">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-3">
                                        ...
                                        <a href="{{ route('tenant_admin.products.edit', ['productId' => $product->id, 'tenant' => $tenantSlug]) }}"
                                            class="text-slate-400 hover:text-indigo-600 font-medium transition-colors">
                                            Editar
                                        </a>
                                        <form method="POST" action="{{ route('tenant_admin.products.duplicate', ['productId' => $product->id, 'tenant' => $tenantSlug]) }}"
